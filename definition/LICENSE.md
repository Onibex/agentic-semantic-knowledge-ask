Onibex ASK Definition — PolyForm Strict License 1.0.0 / PolyForm Free Trial License 1.0.0
Copyright (c) 2026 Onibex, LLC. All rights reserved.

This specification is source-available. You may use it under EITHER of the
...
1. **PolyForm Strict License 1.0.0** (default) — permits any noncommercial
   ...
   specification. Full text: https://polyformproject.org/licenses/strict/1.0.0
2. **PolyForm Free Trial License 1.0.0** — permits evaluation of the
   specification for your business for less than 32 consecutive calendar
   days. Full text: https://polyformproject.org/licenses/free-trial/1.0.0
