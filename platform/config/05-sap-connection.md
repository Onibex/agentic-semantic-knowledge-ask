...
![ASK Setup SAP Connection page: the Connection Details card with host, OData path, username and masked password, and the Test Connection card](../images/config-sap-connection.png)
