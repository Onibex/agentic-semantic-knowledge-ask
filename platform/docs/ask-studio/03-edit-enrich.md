...
| **Time** | 3 to 10 minutes per Data Product |
| **Prerequisites** | At least one Data Product exists (see [Add Data Products](02-add-data-products.md)); a provider configured (see [ASK Setup](../ask-setup/README.md)) for AI Assist. |
